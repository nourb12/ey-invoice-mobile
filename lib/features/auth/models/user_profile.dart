class UserProfile {
  ...
  factory UserProfile.fromJson(Map<String, dynamic> json) {
    ...
    final connectionRaw = readString(const [
      'derniereConnexion',
      'DerniereConnexion',
    ]);
    ...
    return UserProfile(
      ...
      derniereConnexion: connectionRaw == null
          ? null
          : DateTime.tryParse(connectionRaw),
      ...
      alerteConnexion: readBool(const ['alerteConnexion', 'AlerteConnexion']),
    );
  }
