...
class _ScanPreviewScreenState extends State<ScanPreviewScreen> {
  ...
  void initState() {
    ...
    _supplierController = TextEditingController(
      text: widget.initialDraft.supplierName,
    );
    _invoiceNumberController = TextEditingController(
      text: widget.initialDraft.invoiceNumber,
    );
    _invoiceDateController = TextEditingController(
      text: widget.initialDraft.invoiceDate,
    );
    _dueDateController = TextEditingController(
      text: widget.initialDraft.dueDate,
    );
    _totalAmountController = TextEditingController(
      text: widget.initialDraft.totalAmount,
    );
    _subtotalAmountController = TextEditingController(
      text: widget.initialDraft.subtotalAmount,
    );
    _taxAmountController = TextEditingController(
      text: widget.initialDraft.taxAmount,
    );
    _currencyController = TextEditingController(
      text: widget.initialDraft.currency,
    );
  }
                  ...
                  children: [
                    ...
                    EySurfaceCard(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('Texte OCR brut', style: textTheme.titleMedium),
                          const SizedBox(height: 12),
                          SelectableText(
