...
class EyBrandMark extends StatelessWidget {
  const EyBrandMark({super.key, this.size = 34});
...
class EyEyebrow extends StatelessWidget {
  const EyEyebrow({super.key, required this.label});
      ...
      child: Material(
        ...
        child: InkWell(
          ...
          child: Container(
            ...
            child: Icon(
              icon,
              color: onTap == null ? colors.textSecondary : colors.textPrimary,
              size: 20,
            ),
          ),
        ),
...
enum EyStatusTone { ey, neutral, ok, warn, error, info }
